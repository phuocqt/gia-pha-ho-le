          ...
          <div>
            ...
            {mode === "view" && (
              <div className="flex gap-4 justify-center items-center">
                <AuthButton
                  className="mb-2 w-[120px] px-1 bg-blue-500 hover:bg-blue-600 text-white rounded transition duration-300 ease-in-out"
                  onClick={() => {
                    setMode("edit");
                    setData({ ...(node as any) });
                  }}
                ...
                {loggedInUser ? (
                  !isLeader && !isRootNode ? (
                    <>
                      <Button
                        className="mb-2 px-1 w-[80px] bg-red-500 hover:bg-red-600 text-white  rounded transition duration-300 ease-in-out"
                        onClick={() => {
                          setOpenAlert({
                            messenger:
                    ...
                    <>
                      ...
                      <Button
                        className="w-[80px] px-1 mb-2 bg-red-500 hover:bg-red-600 text-white  rounded transition duration-300 ease-in-out"
                        onClick={() => {
                          setOpenAlert({
                            messenger:
                              "Xoá người này có thể làm xoá dữ liệu của con cháu",
